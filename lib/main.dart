...
Future<void> showDetails(Customer c) async {
  ...
  Future<void> takePayment(Customer c) async {
    ...
    if (due <= 0) {
      msg(
        t(
          'এই মাসের কোনো বকেয়া নেই',
          'No due for this month',
        ),
      );
      return;
    }
    ...
    // User-এর Assigned Staff
    // শুরুতেই নির্বাচিত থাকবে।
    int? staffId = c.staffId;
          ...
          content:
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${t('এই মাসের বিল', 'Current month bill')}: ${money(billAmount)} ৳',
                ),
                Text(
                  '${t('পরিশোধ', 'Paid')}: ${money(paidAmount)} ৳',
                ),
                Text(
                  '${t('বকেয়া', 'Due')}: ${money(due)} ৳',
                  style:
                      const TextStyle(
                    fontWeight:
                        FontWeight.bold,
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${t('ক্রমিক', 'Serial')}: ${filtered.indexOf(c) + 1}',
                          style: const TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w700,
                          ),
                        ...
                        Text(
                          'Cust ID: ${c.custId.isEmpty ? '-' : c.custId}',
                          style: TextStyle(
